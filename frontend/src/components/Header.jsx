    ...
    <header className="w-full bg-white shadow-md px-6 py-4 flex items-center justify-between">
      ...
      <div className="hidden lg:flex items-center space-x-3 relative">
        ...
        <button
          ...
          className="p-2 rounded-full bg-green-100 hover:bg-green-200 transition-colors group focus:outline-none focus:ring-0"
        ...
        <button
          ...
          className="p-2 rounded-full bg-purple-100 hover:bg-purple-200 transition-colors group focus:outline-none focus:ring-0"
        ...
        <button
          ...
          className="p-2 rounded-full bg-orange-100 hover:bg-orange-200 transition-colors group focus:outline-none focus:ring-0"
        ...
        <button
          ...
          className="p-2 rounded-full bg-indigo-100 hover:bg-indigo-200 transition-colors group focus:outline-none focus:ring-0"
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 mt-2 w-36 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
              <button
                ...
                className="block w-full text-left px-4 py-2 text-black bg-white hover:bg-blue-100 hover:text-black transition-colors duration-200 rounded-t-lg focus:outline-none focus:ring-0"
              >
                Profile
              </button>
              <button
                onClick={handleLogout}
                className="block w-full text-left px-4 py-2 text-black bg-white hover:bg-blue-100 hover:text-black transition-colors duration-200 rounded-b-lg focus:outline-none focus:ring-0"
              >
                Logout
              </button>
            </div>
      ...
      {/* Mobile Menu Toggle */}
      <button 
        className="lg:hidden p-2 text-blue-700 focus:outline-none focus:ring-0" 
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="absolute top-16 right-4 bg-white shadow-lg rounded-lg p-4 flex flex-col space-y-3 lg:hidden z-50 w-64">
          {/* Post New Stock */}
          <button
            onClick={() => {
              setIsMenuOpen(false);
          ...
          <button
            ...
            className="flex items-center p-2 rounded-lg bg-indigo-100 hover:bg-indigo-200 transition-colors focus:outline-none focus:ring-0"
          >
            <History className="w-5 h-5 text-indigo-700 mr-3" />
            <span className="text-indigo-700 font-medium">Transaction History</span>
          </button>
